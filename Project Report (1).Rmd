...
data <- read.csv("C:/Users/admin/Desktop/project R/Life Expectancy Data.csv")
```
...
-   ${\bf thinness\ 10-\ 19\ years}$ rate of thinness among people aged 10-19
...
${\large\bf Checkig\ Interaction\ terms:}$ Now we can check whether there is correlation between any two variables or not by the help of correlation plot and correlation matrix.
